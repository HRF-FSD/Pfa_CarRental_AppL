...
class carsinfos:
    def __init__(self):
        ...
        self.logout = Button(self.carinfosWindow, text="Go Back", borderwidth=0, font=(14), bg="#2FB04A", fg="white", command=self.logout)
        ...
        for ele in range(1,7):
            (Label(self.carinfo, text=config.data1[ele], fg="white", bg="#2FB04A", font=('Courier', 12, "bold"))).place(x=161, y=y)
            y+=59.5
