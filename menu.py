...
class Menu:
    def __init__(self):
        ...
        self.logout = Button(self.window, text="Logout", borderwidth=0, font=(14), bg="#2FB04A", fg="white", command=self.logout)
        ...
        self.block1_btn = Button(self.window, text=self.block1, borderwidth=0, font=("Courier", 20, "bold"), bg="#2FB04A", fg="white",
        ...
        self.block2_btn = Button(self.window, text=self.block2, borderwidth=0, font=("Courier", 20, "bold"), bg="#2FB04A", fg="white",
